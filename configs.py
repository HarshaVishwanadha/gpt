...
class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('output_images_folder', './outputs',
        ...
        self.define('beam_width', 7, 'The beam search width during evaluation')
        self.define('epochs_to_evaluate', 1, 'The number of epochs to train before evaluating on the test set.')
